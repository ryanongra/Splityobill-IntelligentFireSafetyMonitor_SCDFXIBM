(function (global, factory) {
	...
	(global = global || self, global.models = factory());
	...
	var runObjectDetectionPrediction =
	/*#__PURE__*/
	function () {
	  var _ref = asyncToGenerator(
	  /*#__PURE__*/
	  regenerator.mark(function _callee(graph, labels, input) {
	    var _ref2,
	        _ref2$maxNumberOfBoxe,
	        maxNumberOfBoxes,
	        _ref2$iouThreshold,
	        iouThreshold,
	        _ref2$scoreThreshold,
	        scoreThreshold,
	        batched,
	        height,
	        width,
	    ...
	    return regenerator.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            _ref2 = _args.length > 3 && _args[3] !== undefined ? _args[3] : {}, _ref2$maxNumberOfBoxe = _ref2.maxNumberOfBoxes, maxNumberOfBoxes = _ref2$maxNumberOfBoxe === void 0 ? 20 : _ref2$maxNumberOfBoxe, _ref2$iouThreshold = _ref2.iouThreshold, iouThreshold = _ref2$iouThreshold === void 0 ? 0.5 : _ref2$iouThreshold, _ref2$scoreThreshold = _ref2.scoreThreshold, scoreThreshold = _ref2$scoreThreshold === void 0 ? 0.5 : _ref2$scoreThreshold;
	            batched = Ke(function () {
	              var img = Mf.fromPixels(input); // Reshape to a single-element batch so we can pass it to executeAsync.
	          ...
	          case 6:
	            ...
	            batched.dispose();
	            je(result);
	            _calculateMaxScores = calculateMaxScores(scores, result[0].shape[1], result[0].shape[2]), _calculateMaxScores2 = slicedToArray(_calculateMaxScores, 2), maxScores = _calculateMaxScores2[0], classes = _calculateMaxScores2[1];
	            prevBackend = Je(); // run post process in cpu

	            Ye("cpu");
	            indexTensor = Ke(function () {
	              var boxes2 = Dn(boxes, [result[1].shape[1], result[1].shape[3]]);
	              return vh.nonMaxSuppression(boxes2, maxScores, maxNumberOfBoxes, iouThreshold, scoreThreshold);
	            });
	...
	var runClassificationPrediction =
	/*#__PURE__*/
	function () {
	  var _ref3 = asyncToGenerator(
	  /*#__PURE__*/
	  regenerator.mark(function _callee2(graph, labels, input) {
	    var batched,
	        results,
	        scores,
	        finalScores;
	    return regenerator.wrap(function _callee2$(_context2) {
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          case 0:
	            batched = Ke(function () {
	              var img = Mf.fromPixels(input);
	              var small = vh.resizeBilinear(img, [224, 224]).div(255); // Reshape to a single-element batch so we can pass it to executeAsync.
	            ...
	            results.dispose();
	            batched.dispose();
	            finalScores = scores.map(function (score, i) {
	              return {
	                label: labels[i],
	                score: score
	              };
	...
	var checkControlFlow = function checkControlFlow(graph) {
	  return Object.values(graph.executor.graph.nodes).find(function (n) {
	    return CONTROL_FLOW_OPS$1.includes(n.op);
	  }) !== undefined;
	};
	...
	var index = {
	  load: function () {
	    ...
	    /*#__PURE__*/
	    regenerator.mark(function _callee5(path) {
	      var graphPath, labelsPath, graphPromise, labelsPromise, _ref4, _ref5, graph, labels, hasControlFlowOps;
	        ...
	        while (1) {
	          switch (_context5.prev = _context5.next) {
	            case 0:
	              ...
	              graphPromise = loadGraphModel(graphPath);
	            ...
	            case 6:
	              ...
	              return _context5.abrupt("return", {
	                type: TYPE_DETECTION,
	                detect: function () {
	                  var _detect = asyncToGenerator(
	                  /*#__PURE__*/
	                  regenerator.mark(function _callee3(input, options) {
	            ...
	            case 13:
	              return _context5.abrupt("return", {
	                ...
	                classify: function () {
	                  var _classify = asyncToGenerator(
	                  /*#__PURE__*/
	                  regenerator.mark(function _callee4(input, options) {
